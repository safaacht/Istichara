...
<div class="profile-card">
    <h1><i class="fas fa-user icon-person"></i><?= htmlspecialchars($Hussier->getName()) ?></h1>

    <div class="info">
        <i class="fas fa-briefcase icon-experience"></i>
        <span><strong>Experience:</strong> <?= $Hussier->getExpYears() ?> years</span>
    </div>
    <div class="info">
        <i class="fas fa-gavel icon-specialization"></i>
        <span><strong>Specialization:</strong> <?= $Hussier->getType()->value ?></span>
    </div>
    <div class="info">
        <i class="fas fa-eye icon-views"></i>
        <span><strong>Views:</strong> <?= $Hussier->getNumviwers() ?></span>
    </div>
</div>
